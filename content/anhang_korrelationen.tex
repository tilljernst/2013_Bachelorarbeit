...
\begin{table}[H] 
    \centering
    \caption{Zusammenhang zwischen Medien-Multitasking und der Aufmerksamkeitskontrolle Aufteilung anhand dem Geschlecht, Korrelationen}
    \begin{tabular}[t]{|L{15mm} R{25mm}|R{25mm}|R{25mm}|R{25mm}|} 
        \hline
        \multicolumn{5}{|c|}{\textbf{Korrelationen aufgeteilt nach dem Geschlecht}}\\ 
        \hline       
        \multicolumn{3}{|c|}{} & \multicolumn{1}{c|}{$MMI_{angepasst}$} &\multicolumn{1}{c|}{$ACS$} \\
        \multicolumn{3}{|l|}{Geschlecht} & \multicolumn{1}{c|}{($MMI$)} & \multicolumn{1}{c|}{}\\
        \hline
        weiblich & $MMI_{angepasst}$ ($MMI$) & Korrelation nach Pearson & 1 \newline (1) & .052 \newline (.051)\\
        & & Signifikanz (2-seitig) & & .111 \newline (.117)\\
        & & $N$ & 955 & 955\\
        \hline
        männlich & $MMI_{angepasst}$ ($MMI$) & Korrelation nach Pearson & 1 \newline (1) & .127* \newline (.127*) \\
...
\begin{table}[H] 
    \centering
    \caption{Zusammenhang zwischen Aufmerksamkeitskontrolle und subjektivem Wohlbefinden Aufteilung anhand dem Geschlecht, Korrelationen}
