...
TBD: Erwartete und unerwartete Ergebnisse. Ev. Störvariablen vorhanden?
...
\begin{itemize}
    \item $MMI_{ext}$ und $MMI$
    \item MUQ - Alle Medien gleich bewertet
    \item ACS - Selbstbeurteilung der Aufmerksamkeitskontrolle
\end{itemize}
