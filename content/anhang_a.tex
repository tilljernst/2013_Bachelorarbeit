...
\section{Übersetzung \textit{Media Use Questionnaire}}\label{appendix.muq}
Der Fragebogen zur Häufigkeit von Mediennutzung (engl. Media Use Questionnaire) ist ein Bestandteil des \textit{Medien Multitasking Index (MMI)} \cite{Ophir2009}. Die Bewertung erfolgt mittels folgender Skala: 1 = meistens (engl.: most of the time); 0.67 = etwas (engl.: some of the time); 0.33 = wenig (engl.: a little of the time); 0 = nie (engl.: never).  \\
...
% Attentional Control Scale
\section{Übersetzung \textit{Attentional Control Scale}}\label{appendix.acs}
